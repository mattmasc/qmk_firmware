...
__attribute__((weak)) bool sentence_case_check_ending(const uint16_t* buffer) {
  ...
  if (
      ...
      SENTENCE_CASE_JUST_TYPED(KC_SPC, KC_M, KC_I, KC_S, KC_C, KC_DOT) || // "misc."
      SENTENCE_CASE_JUST_TYPED(KC_SPC, KC_T, KC_E, KC_L, KC_DOT) || // "tel."
      SENTENCE_CASE_JUST_TYPED(KC_SPC, KC_C, KC_E, KC_L, KC_DOT) || // "cel."
      SENTENCE_CASE_JUST_TYPED(KC_SPC, KC_P, KC_A, KC_G, KC_DOT) || // "pag."
      SENTENCE_CASE_JUST_TYPED(KC_SPC, KC_E, KC_C, KC_C, KC_DOT) || // "ecc."
      SENTENCE_CASE_JUST_TYPED(KC_SPC, KC_E, KC_S, KC_DOT) // "es."
  ) {
